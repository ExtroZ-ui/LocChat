...
namespace serverChat
{
    public class Client
    {
        ...
        private void handleCommand(string data)  // Обработка
        {
        ...
        public void UpdateChat() // Обновление чата
        {
            Send(ChatController.GetChat());
        }
        public void Send(string command)  //Отправка
        {
            try
            {
